...
<div id="oca-delivery-options">
     {if $psver < 1.6}
        <h3 class="carrier_title">{l s='Selecciona la sucursal donde recibirás tu pedido:' mod='ocaepak'}</h3>
    {else}
        <p class="carrier_title">{l s='Selecciona la sucursal donde recibirás tu pedido:' mod='ocaepak'}</p>
    {/if}
...
{*        <div id="oca-map"></div>*}
        {if $ocaepak_branch_sel_type == 1}
            <div class="radius-input">
                <label for="ocaBranchSelect">{l s='Sucursal seleccionada' mod='ocaepak'}:</label>
