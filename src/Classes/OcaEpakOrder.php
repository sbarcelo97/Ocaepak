...
class OcaEpakOrder extends ObjectModel
{
    ...
    public static function generateOrderXml($data)
    {
        ...
        $config['timeslot'] = (
            in_array($data['operative']->type, ['PaP', 'PaS'])
    ...
    public static function parseOcaAddress($address)
    {
        ...
        $remainingAddress = str_replace(['Nº', 'Nª', 'N°', 'nº', 'nª', 'n°'], '', $remainingAddress);
...
>>>>>>> 683143f90caad09439848bcdf071bdb719e4ed2b
        } else {
