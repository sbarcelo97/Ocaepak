...
<div class="row">
    <div class="col-xs-12 col-md-6">
        <div class="address alternate_item box">
            <h3 class="page-subheading">{l s='Información Oca Epak' mod='ocaepak'}</h3>
            <dl class="list-detail">
                <dt>{l s='Sucursal seleccionada' mod='ocaepak'}</dt>
                ...
                <dt>{l s='Dirección de la Sucursal' mod='ocaepak'}</dt>
                <dd>
                ...
                <dt>{l s='Código Postal de la Sucursal' mod='ocaepak'}</dt>
                <dd>{$distributionCenter['CodigoPostal']|trim|escape:'htmlall':'UTF-8'}</dd>
                <dt>{l s='Número telefónico' mod='ocaepak'}</dt>
